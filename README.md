...
- Update the path in `RAG.py`:
  ```python
  loader = TextLoader("path/to/speech.txt")
  ```
...
- Obtain keys from:
  - [Google Cloud Console](https://console.cloud.google.com/) (`GOOGLE_API_KEY`)
  - [Groq Console](https://console.groq.com/) (`GROQ_API_KEY`)
  - [LangSmith Dashboard](https://smith.langchain.com/) (`LANGSMITH_API_KEY`, `LANGCHAIN_API_KEY`)
